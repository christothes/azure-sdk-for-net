...
namespace Azure.Identity.Tests
{
    public class VisualStudioCodeCredentialLiveTests : IdentityRecordedTestBase
    {
        ...
        public async Task AuthenticateWithVscCredential()
        {
            ...
            AccessToken token = await credential.GetTokenAsync(new TokenRequestContext(new[] {"https://vault.azure.net/.default"}, default), CancellationToken.None);
        ...
        public void AuthenticateWithVscCredential_InvalidRefreshToken()
        {
            ...
            Assert.ThrowsAsync<CredentialUnavailableException>(async () => await credential.GetTokenAsync(new TokenRequestContext(new[] {".default"}, default), CancellationToken.None));
        }
    }
}
