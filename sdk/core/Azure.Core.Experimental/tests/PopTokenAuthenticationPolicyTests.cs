    ...
    public class PopTokenAuthenticationPolicyTests : SyncAsyncPolicyTestBase
    {
        ...
        public async Task PopTokenAuthenticationPolicy_HandlesPopChallenge()
        {
            ...
            var credential = new TokenCredentialStub((r, c) =>
            {
                ...
                return new(Guid.NewGuid().ToString(), DateTimeOffset.Now.AddHours(2), "PoP");
            }, IsAsync);
        ...
        [Test]
        public async Task PopTokenAuthenticationPolicy_FallsBackToBearer()
        {
        ...
        {
            var credential = new TokenCredentialStub(
                (r, c) => r.Scopes.SequenceEqual(new[] { "scope" }) ? new AccessToken("token", DateTimeOffset.MaxValue, "PoP") : default,
                IsAsync);
