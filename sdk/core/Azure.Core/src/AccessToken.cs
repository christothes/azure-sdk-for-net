...
namespace Azure.Core
{
    ...
    public struct AccessToken
    {
        ...
        /// <param name="accessToken">The bearer access token value.</param>
        /// <param name="expiresOn">The bearer access token expiry date.</param>
        /// <param name="refreshOn">The bearer access token date at which the token should be refreshed.</param>
        ...
        /// <summary>
        /// Gets the time when the provided token should be refreshed.
        /// </summary>
