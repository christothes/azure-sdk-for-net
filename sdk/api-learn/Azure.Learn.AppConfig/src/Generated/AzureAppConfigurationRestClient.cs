...
namespace Azure.Learn.AppConfig
{
    internal partial class AzureAppConfigurationRestClient
    {
        ...
        public async Task<ResponseWithHeaders<KeyValue, AzureAppConfigurationGetKeyValueHeaders>> GetKeyValueAsync(string key, string label = null, string acceptDatetime = null, string ifMatch = null, string ifNoneMatch = null, IEnumerable<SettingFields> select = null, CancellationToken cancellationToken = default)
        {
            if (key == null)
            {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="key"/> is null. </exception>
        public ResponseWithHeaders<KeyValue, AzureAppConfigurationGetKeyValueHeaders> GetKeyValue(string key, string label = null, string acceptDatetime = null, string ifMatch = null, string ifNoneMatch = null, IEnumerable<SettingFields> select = null, CancellationToken cancellationToken = default)
        {
            if (key == null)
            {
                throw new ArgumentNullException(nameof(key));
