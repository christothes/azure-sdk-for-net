...
{
    internal partial class MiniAppConfigRestClient
    {
        ...
        /// <summary> Initializes a new instance of MiniAppConfigRestClient. </summary>
        ...
        public MiniAppConfigRestClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string endpoint, string apiVersion = "1.0")
        {
            if (endpoint == null)
            {
